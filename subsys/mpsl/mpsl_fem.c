...
#error Node with label 'nrf_radio_fem' not found in the devicetree.
	...
	if (NRFX_SUCCESS != nrfx_gpiote_channel_alloc(&txen_gpiote_channel)) {
		return -ENOMEM;
	}
#endif
	...
	if (NRFX_SUCCESS != nrfx_gpiote_channel_alloc(&rxen_gpiote_channel)) {
		return -ENOMEM;
	}
#endif
	...
	if (NRFX_SUCCESS != nrfx_gpiote_channel_alloc(&pdn_gpiote_channel)) {
		return -ENOMEM;
	}
#endif
...
#error Node with label 'nrf_radio_fem' not found in the devicetree.
	...
	if (NRFX_SUCCESS != nrfx_gpiote_channel_alloc(&ctx_gpiote_channel)) {
		return -ENOMEM;
	}
#endif
	...
	if (NRFX_SUCCESS != nrfx_gpiote_channel_alloc(&crx_gpiote_channel)) {
		return -ENOMEM;
	}
#endif
